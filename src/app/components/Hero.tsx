...
import digitallreport from "../../assets/icons/nabl.svg";
            ...
            {banners.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === selectedIndex
                    ? "bg-blue-600 lg:bg-blue-600 scale-125"
                    : "bg-gray-300 lg:bg-white/70"
                }`}
        ...
        <div className="flex lg:hidden items-center justify-between md:justify-center gap-2 md:gap-4 w-full mt-10 px-4 md:px-8 flex-wrap">
          <div className="flex flex-col md:flex-row items-center justify-center flex-1 md:flex-initial py-1.5 md:py-2 px-0.5 md:px-4 bg-white border border-[#0076BC] rounded md:rounded-md shadow-sm h-[60px] md:h-auto md:min-h-0">
            <img
              src={home}
              alt="Home"
              className="w-4 md:w-4 h-4 md:h-4 mb-1 md:mb-0 md:mr-2 object-contain"
            />
            <span className="text-[9px] md:text-[13px] font-medium text-[#0076BC] md:text-gray-700 whitespace-normal md:whitespace-nowrap text-center md:text-left leading-tight md:leading-none">
              Home
              <span className="md:hidden">
                <br />
              </span>
              <span className="hidden md:inline"> </span>Collection
            </span>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-center flex-1 md:flex-initial py-1.5 md:py-2 px-0.5 md:px-4 bg-white border border-[#0076BC] rounded md:rounded-md shadow-sm h-[60px] md:h-auto md:min-h-0">
            <img
            ...
            <span className="text-[9px] md:text-[13px] font-medium text-[#0076BC] md:text-gray-700 whitespace-normal md:whitespace-nowrap text-center md:text-left leading-tight md:leading-none">
              ...
              <span className="hidden md:inline"> </span>Accredited
            </span>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-center flex-1 md:flex-initial py-1.5 md:py-2 px-0.5 md:px-4 bg-white border border-[#0076BC] rounded md:rounded-md shadow-sm h-[60px] md:h-auto md:min-h-0">
            <img
            ...
            <span className="text-[9px] md:text-[13px] font-medium text-[#0076BC] md:text-gray-700 whitespace-normal md:whitespace-nowrap text-center md:text-left leading-tight md:leading-none">
              ...
              <span className="hidden md:inline"> </span>Reports
            </span>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-center flex-1 md:flex-initial py-1.5 md:py-2 px-0.5 md:px-4 bg-white border border-[#0076BC] rounded md:rounded-md shadow-sm h-[60px] md:h-auto md:min-h-0">
            <img
            ...
            <span className="text-[9px] md:text-[13px] font-medium text-[#0076BC] md:text-gray-700 whitespace-normal md:whitespace-nowrap text-center md:text-left leading-tight md:leading-none">
              ...
              <span className="hidden md:inline"> </span>India
            </span>
          </div>
        </div>
